...
sub petscii_initialize {
    ...
    $self->{'petscii_meta'} = {
        ...
        'REVERSE SPACE'                           => { 'out' => chr(160), 'unicode' => ' ', 'desc' => 'Dithered Box Full', },
        'REVERSE LEFT HALF'                       => { 'out' => chr(161), 'unicode' => '▌', 'desc' => 'Left Half', },
        'REVERSE BOTTOM BOX'                      => { 'out' => chr(162), 'unicode' => '▄', 'desc' => 'Bottom Box', },
        'REVERSE TOP HORIZONTAL BAR'              => { 'out' => chr(163), 'unicode' => '▔', 'desc' => 'Top Horizontal Bar', },
        'REVERSE BOTTOM HORIZONTAL BAR'           => { 'out' => chr(164), 'unicode' => '▁', 'desc' => 'Bottom Horizontal Bar', },
        'REVERSE LEFT VERTICAL BAR'               => { 'out' => chr(165), 'unicode' => '▎', 'desc' => 'Left Vertical Bar', },
        'REVERSE DITHERED BOX'                    => { 'out' => chr(166), 'unicode' => '▒', 'desc' => 'Dithered Box', },
        'REVERSE RIGHT VERTICAL BAR'              => { 'out' => chr(167), 'unicode' => '🮈', 'desc' => 'Right Vertical Bar', },
        'REVERSE DITHERED BOTTOM'                 => { 'out' => chr(168), 'unicode' => '🮏', 'desc' => 'Dithered Left', },
        'REVERSE BOTTOM RIGHT WEDGE'              => { 'out' => chr(169), 'unicode' => '◤', 'desc' => 'Bottom Right Wedge', },
		'REVERSE VERTICAL BAR RIGHT'              => { 'out' => chr(170), 'unicode' => '🮈', 'desc' => 'Vertical bar flushed right', },
        'REVERSE VERTICAL BAR MIDDLE LEFT'        => { 'out' => chr(171), 'unicode' => '├', 'desc' => 'Vertical Bar Middle Left', },
        'REVERSE BOTTOM RIGHT BOX'                => { 'out' => chr(172), 'unicode' => '▗', 'desc' => 'Bottom Right Box', },
        'REVERSE BOTTOM LEFT CORNER'              => { 'out' => chr(173), 'unicode' => '└', 'desc' => 'Bottom Left Corner', },
        'REVERSE TOP RIGHT CORNER'                => { 'out' => chr(174), 'unicode' => '┐', 'desc' => 'Top Right Corner', },
        'REVERSE HORIZONTAL BAR BOTTOM'           => { 'out' => chr(175), 'unicode' => '▂', 'desc' => 'Horizontal Bar Bottom', },
        'REVERSE TOP LEFT CORNER'                 => { 'out' => chr(176), 'unicode' => '┌', 'desc' => 'Top Left Corner', },
        'REVERSE HORIZONTAL BAR MIDDLE BOTTOM'    => { 'out' => chr(177), 'unicode' => '┴', 'desc' => 'Horizontal Bar Middle Bottom', },
        'REVERSE HORIZONTAL BAR MIDDLE TOP'       => { 'out' => chr(178), 'unicode' => '┬', 'desc' => 'Horizontal Bar Middle Top', },
        'REVERSE VERTICAL BAR MIDDLE RIGHT'       => { 'out' => chr(179), 'unicode' => '┤', 'desc' => 'Vertical Bar Middle Right', },
        'REVERSE VERTICAL BOX LEFT'               => { 'out' => chr(180), 'unicode' => '▍', 'desc' => 'Vertical Box Left', },
        'REVERSE LEFT HALF BOX'                   => { 'out' => chr(181), 'unicode' => '▌', 'desc' => 'Left Half Box', },
		'REVERSE RIGHT HALF BOX'                  => { 'out' => chr(182), 'unicode' => '🮈', 'desc' => 'Right half box', },
		'REVERSE HORIZONTAL BAR TOP'              => { 'out' => chr(183), 'unicode' => '🮂', 'desc' => 'Horizontal bar top', },
		'REVERSE HORIZONTAL BAR THICK TOP'        => { 'out' => chr(184), 'unicode' => '🮃', 'desc' => 'Horizontal bar thick top', },
		'REVERSE HORIZONTAL BAR THICK BOTTOM'     => { 'out' => chr(185), 'unicode' => '▃', 'desc' => 'Horizontal bar thick bottom', },
		'REVERSE BOTTOM RIGHT RIGHT ANGLE'        => { 'out' => chr(186), 'unicode' => '🭿', 'desc' => 'Bottom right right angle', },
        'REVERSE BOTTOM LEFT BOX'                 => { 'out' => chr(187), 'unicode' => '▖', 'desc' => 'Bottom Left Box', },
        'REVERSE TOP RIGHT BOX'                   => { 'out' => chr(188), 'unicode' => '▝', 'desc' => 'Top Right Box', },
        'REVERSE BOTTOM RIGHT CORNER'             => { 'out' => chr(189), 'unicode' => '┘', 'desc' => 'Bottom Right Corner', },
        'REVERSE TOP LEFT BOX'                    => { 'out' => chr(190), 'unicode' => '▘', 'desc' => 'Top Left Box', },
        'REVERSE TOP LEFT BOTTOM RIGHT BOX'       => { 'out' => chr(191), 'unicode' => '▚', 'desc' => 'Top Left Bottom Right Box', },
		'REVERSE HORIZONTAL BAR'                  => { 'out' => chr(192), 'unicode' => '🭹', 'desc' => 'Horizontal bar', },
        'REVERSE SPADE DUPLICATE'                 => { 'out' => chr(193), 'unicode' => '♠', 'desc' => 'Spade', },
        'REVERSE VERTICAL BAR CENTER DUPLICATE'   => { 'out' => chr(194), 'unicode' => '│', 'desc' => 'Giant Vertical Bar', },
        'REVERSE HORIZONTAL BAR DUPLICATE'        => { 'out' => chr(195), 'unicode' => '─', 'desc' => 'Horizontal Bar', },
        'REVERSE HORIZONTAL BAR SMALL UPPER BIAS' => { 'out' => chr(196), 'unicode' => '🭸', 'desc' => 'Horizontal bar with a slight upper bias', },
		'REVERSE HORIZONTAL BAR LARGE UPPER BIAS' => { 'out' => chr(197), 'unicode' => '🭶', 'desc' => 'Horizontal bar with a strong upper bias', },
		'REVERSE HORIZONTAL BAR SMALL LOWER BIAS' => { 'out' => chr(198), 'unicode' => '🭺', 'desc' => 'Horizontal bar with a slight lower bias', },
		'REVERSE VERTICAL BAR SMALL LEFT BIAS'    => { 'out' => chr(199), 'unicode' => ' ', 'desc' => 'Vertical bar with a slight left bias', },
		'REVERSE VERTICAL BAR SMALL RIGHT BIAS'   => { 'out' => chr(200), 'unicode' => ' ', 'desc' => 'Vertical bar with a slight right bias', },
        'REVERSE TOP RIGHT ROUNDED CORNER'        => { 'out' => chr(201), 'unicode' => '╮', 'desc' => 'Top Right Rounded Corner', },
        'REVERSE BOTTOM LEFT ROUNDED CORNER'      => { 'out' => chr(202), 'unicode' => '╰', 'desc' => 'Bottom Left Rounded Corner', },
        'REVERSE BOTTOM RIGHT ROUNDED CORNER'     => { 'out' => chr(203), 'unicode' => '╯', 'desc' => 'Bottom Right Rounded Corner', },
		'REVERSE BOTTOM LEFT RIGHT ANGLE'         => { 'out' => chr(204), 'unicode' => '⎿', 'desc' => 'Bottom left right angle', },
        'REVERSE GIANT BACKSLASH'                 => { 'out' => chr(205), 'unicode' => '╲', 'desc' => 'Giant Backslash', },
        'REVERSE GIANT FORWARD SLASH'             => { 'out' => chr(206), 'unicode' => '╱', 'desc' => 'Giant Forward Slash', },
		'REVERSE TOP LEFT RIGHT ANGLE'            => { 'out' => chr(207), 'unicode' => '⎾', 'desc' => 'Top left right angle', },
		'REVERSE TOP RIGHT RIGHT ANGLE'           => { 'out' => chr(208), 'unicode' => ' ', 'desc' => 'Top right right angle', },
		'REVERSE CENTER DOT'                      => { 'out' => chr(209), 'unicode' => '•', 'desc' => 'CENTER DOT', },
		'REVERSE HORIZONTAL BAR LARGE LOWER BIAS' => { 'out' => chr(210), 'unicode' => '🭻', 'desc' => 'Horizontal bar with a strong lower bias', },
        'REVERSE HEART'                           => { 'out' => chr(211), 'unicode' => '♥', 'desc' => 'Heart', },
		'REVERSE VERTICAL BAR LARGE LEFT BIAS'    => { 'out' => chr(212), 'unicode' => ' ', 'desc' => 'Vertical bar with a strong left bias', },
        'REVERSE TOP LEFT ROUNDED CORNER'         => { 'out' => chr(213), 'unicode' => '╭', 'desc' => 'Top Left Rounded Corner', },
        'REVERSE GIANT X'                         => { 'out' => chr(214), 'unicode' => '╳', 'desc' => 'Giant X', },
        'REVERSE THIN CIRCLE'                     => { 'out' => chr(215), 'unicode' => '○', 'desc' => 'Thin Circle', },
        'REVERSE CLUB'                            => { 'out' => chr(216), 'unicode' => '♣', 'desc' => 'Club', },
		'REVERSE VERTICAL BAR LARGE RIGHT BIAS'   => { 'out' => chr(217), 'unicode' => ' ', 'desc' => 'Vertical bar with a strong right bias', },
        'REVERSE DIAMOND'                         => { 'out' => chr(218), 'unicode' => '♦', 'desc' => 'Diamond', },
        'REVERSE CROSS BAR'                       => { 'out' => chr(219), 'unicode' => '┼', 'desc' => 'Cross Bar', },
		'REVERSE SHADE LEFT'                      => { 'out' => chr(220), 'unicode' => '🮌', 'desc' => 'Shade left', },
		'REVERSE VERTICAL BAR'                    => { 'out' => chr(221), 'unicode' => '┃', 'desc' => 'Vertical bar', },
        'REVERSE PI'                              => { 'out' => chr(222), 'unicode' => 'π', 'desc' => 'Pi symbol', },
        'REVERSE BOTTOM LEFT WEDGE'               => { 'out' => chr(223), 'unicode' => '◥', 'desc' => 'Bottom Left Wedge', },
        'REVERSE SPACE 2'                         => { 'out' => chr(224), 'unicode' => ' ', 'desc' => 'Dithered Box Full', },
        'REVERSE LEFT HALF 2'                     => { 'out' => chr(225), 'unicode' => '▌', 'desc' => 'Left Half', },
        'REVERSE BOTTOM BOX 2'                    => { 'out' => chr(226), 'unicode' => '▄', 'desc' => 'Bottom Box', },
        'REVERSE TOP HORIZONTAL BAR 2'            => { 'out' => chr(227), 'unicode' => '▔', 'desc' => 'Top Horizontal Bar', },
        'REVERSE BOTTOM HORIZONTAL BAR 2'         => { 'out' => chr(228), 'unicode' => '▁', 'desc' => 'Bottom Horizontal Bar', },
        'REVERSE LEFT VERTICAL BAR 2'             => { 'out' => chr(229), 'unicode' => '▎', 'desc' => 'Left Vertical Bar', },
        'REVERSE DITHERED BOX 2'                  => { 'out' => chr(230), 'unicode' => '▒', 'desc' => 'Dithered Box', },
        'REVERSE RIGHT VERTICAL BAR 2'            => { 'out' => chr(231), 'unicode' => '🮈', 'desc' => 'Right Vertical Bar', },
        'REVERSE DITHERED BOTTOM 2'               => { 'out' => chr(232), 'unicode' => '🮏', 'desc' => 'Dithered Left', },
        'REVERSE BOTTOM RIGHT WEDGE 2'            => { 'out' => chr(233), 'unicode' => '◤', 'desc' => 'Bottom Right Wedge', },
		'REVERSE VERTICAL BAR RIGHT 2'            => { 'out' => chr(234), 'unicode' => '🮈', 'desc' => 'Vertical bar flushed right', },
        'REVERSE VERTICAL BAR MIDDLE LEFT 2'      => { 'out' => chr(235), 'unicode' => '├', 'desc' => 'Vertical Bar Middle Left', },
        'REVERSE BOTTOM RIGHT BOX 2'              => { 'out' => chr(236), 'unicode' => '▗', 'desc' => 'Bottom Right Box', },
        'REVERSE BOTTOM LEFT CORNER 2'            => { 'out' => chr(237), 'unicode' => '└', 'desc' => 'Bottom Left Corner', },
        'REVERSE TOP RIGHT CORNER 2'              => { 'out' => chr(238), 'unicode' => '┐', 'desc' => 'Top Right Corner', },
        'REVERSE HORIZONTAL BAR BOTTOM 2'         => { 'out' => chr(239), 'unicode' => '▂', 'desc' => 'Horizontal Bar Bottom', },
        'REVERSE TOP LEFT CORNER 2'               => { 'out' => chr(240), 'unicode' => '┌', 'desc' => 'Top Left Corner', },
        'REVERSE HORIZONTAL BAR MIDDLE BOTTOM 2'  => { 'out' => chr(241), 'unicode' => '┴', 'desc' => 'Horizontal Bar Middle Bottom', },
        'REVERSE HORIZONTAL BAR MIDDLE TOP 2'     => { 'out' => chr(242), 'unicode' => '┬', 'desc' => 'Horizontal Bar Middle Top', },
        'REVERSE VERTICAL BAR MIDDLE RIGHT 2'     => { 'out' => chr(243), 'unicode' => '┤', 'desc' => 'Vertical Bar Middle Right', },
        'REVERSE VERTICAL BOX LEFT 2'             => { 'out' => chr(244), 'unicode' => '▍', 'desc' => 'Vertical Box Left', },
        'REVERSE LEFT HALF BOX 2'                 => { 'out' => chr(245), 'unicode' => '▌', 'desc' => 'Left Half Box', },
		'REVERSE RIGHT HALF BOX 2'                => { 'out' => chr(246), 'unicode' => '🮈', 'desc' => 'Right half box', },
		'REVERSE HORIZONTAL BAR TOP 2'            => { 'out' => chr(247), 'unicode' => '🮂', 'desc' => 'Horizontal bar top', },
		'REVERSE HORIZONTAL BAR THICK TOP 2'      => { 'out' => chr(248), 'unicode' => '🮃', 'desc' => 'Horizontal bar thick top', },
		'REVERSE HORIZONTAL BAR THICK BOTTOM 2'   => { 'out' => chr(249), 'unicode' => '▃', 'desc' => 'Horizontal bar thick bottom', },
		'REVERSE BOTTOM RIGHT RIGHT ANGLE 2'      => { 'out' => chr(250), 'unicode' => '🭿', 'desc' => 'Bottom right right angle', },
        'REVERSE BOTTOM LEFT BOX 2'               => { 'out' => chr(251), 'unicode' => '▖', 'desc' => 'Bottom Left Box', },
        'REVERSE TOP RIGHT BOX 2'                 => { 'out' => chr(252), 'unicode' => '▝', 'desc' => 'Top Right Box', },
        'REVERSE BOTTOM RIGHT CORNER 2'           => { 'out' => chr(253), 'unicode' => '┘', 'desc' => 'Bottom Right Corner', },
        'REVERSE TOP LEFT BOX 2'                  => { 'out' => chr(254), 'unicode' => '▘', 'desc' => 'Top Left Box', },
        'REVERSE PI 2'                            => { 'out' => chr(255), 'unicode' => 'π', 'desc' => 'Pi symbol', },
	};
...
sub sysop_list_commands {
    ...
    if ($mode && $mode eq 'ASCII') {
        ...
        $table->hr();
        while (scalar(@atatkn)) {
            my $atascii_tokens = shift(@atatkn);
        ...
        $table->hr();
        while (scalar(@pettkn)) {
            my $petscii_tokens = shift(@pettkn);
